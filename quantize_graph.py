...
flags.DEFINE_string("input", "E:/cls_14_20190824.pb", """TensorFlow 'GraphDef' file to load.""")
flags.DEFINE_string("output_node_names", "MobilenetV1/Predictions/Reshape_1",
                    """Output node names, comma separated.""")
flags.DEFINE_string("output", "E:/quantized_graph.pb", """File to save the output graph to.""")
