...
def main(unused_args):
  ...
  print('frozen graph have writen in %s'%FLAGS.output_graph)
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--input_graph",
      type=str,
      #default="/home/tnc/PycharmProjects/slim/mbnet_224/mbnet_inf_graph.pb",
      default="E:/Classify_Data/Models"
              "/20190830_poker_3232_gray_cls_14_mobivenet/architecture_graph.pb",
  ...
  parser.add_argument(
      "--input_checkpoint",
      type=str,
      #default="/home/tnc/PycharmProjects/slim/mbnet_224/mobilenet_v1_1.0_224.ckpt",
      default="E:/Classify_Data/Models"
              "/20190830_poker_3232_gray_cls_14_mobivenet/model.ckpt-1614627",
      help="TensorFlow variables file to load.")
  parser.add_argument(
      "--output_graph",
      type=str,
      #default="/home/tnc/PycharmProjects/slim/mbnet_224/mbnet_frozen_graph.pb",
      default="E:/Classify_Data/Models"
              "/20190830_poker_3232_gray_cls_14_mobivenet/frozen_graph.pb",
  ...
  parser.add_argument(
      ...
      type="bool",
      default=True,
      help="Whether the input files are in binary format.")#False
  parser.add_argument(
      "--output_node_names",
      type=str,
      #default="Predictions/Reshape_1",#lenet
      default="MobilenetV1/Predictions/Reshape_1",#mobilenet_v1
      #default="MobilenetV2/Predictions/Reshape_1",  # mobilenet_v2
